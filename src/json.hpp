...
<body>
  <downloads-manager><template shadowrootmode="open"><!----><!--_html_template_start_-->
<downloads-toolbar id="toolbar" role="none"><template shadowrootmode="open"><!----><!--_html_template_start_-->
<cr-toolbar id="toolbar" page-name="下载记录" autofocus="" always-show-logo="" search-prompt="搜索下载记录" clear-label="清除搜索字词"><template shadowrootmode="open"><!---->
<div id="leftContent">
  <div id="leftSpacer">
    <!--?lit$8292145023$-->
    ...
    <h1><!--?lit$8292145023$-->下载记录</h1>
  </div>
</div>

<div id="centeredContent">
  <cr-toolbar-search-field id="search" label="搜索下载记录" clear-label="清除搜索字词" autofocus="" icon-override="" input-aria-description=""><template shadowrootmode="open"><!---->
<div id="background"></div>
<div id="stateBackground"></div>
<div id="content">
  <!--?lit$8292145023$-->
    <cr-icon-button id="icon" suppress-rtl-flip="" iron-icon="cr:search" title="搜索下载记录" tabindex="-1" aria-hidden="true" role="button" aria-disabled="false"><template shadowrootmode="open"><!---->
<div id="icon">
...
<div id="mainContainer">
  <managed-footnote managed-by-icon_=""><template shadowrootmode="open"><!----><!--?lit$8292145023$--><!--?--></template></managed-footnote>
  <cr-infinite-list id="downloadsList" role="grid" aria-rowcount="21"><template shadowrootmode="open"><!----><slot></slot></template>
  <!----><cr-lazy-list id="list" chunk-size="0" style="--list-item-size: 100px; --chunk-height: 0px;"><template shadowrootmode="open"><!----><div id="container" style="height: 2536.8px;"><slot id="slot"></slot></div></template>
        <!----><!---->
  
  
        <downloads-item tabindex="0" aria-rowindex="1" id="frb0" role="row" class="no-outline"><template shadowrootmode="open"><!----><!--_html_template_start_-->
<div id="date" role="heading" aria-level="2"><!--?lit$8292145023$-->今天</div>

<div id="content" focus-row-container="" class="is-active show-progress focus-row-active">
  <div id="main-content">
    <div id="file-icon-wrapper" class="icon-wrapper" role="img" aria-label="" aria-hidden="true">
      <img class="icon" id="file-icon" alt="" icon-color="" src="chrome://fileicon/?path=E%3A%5CBrick_game%5Csrc%5Cjson.hpp&amp;scale=1.5x">
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        ...
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="chrome://downloads/" title="json.hpp" tabindex="0" role="link" hidden=""><!-- No line break
          --><!--?lit$8292145023$-->json.hpp<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="json.hpp"><!-- No line break
          --><!--?lit$8292145023$-->json.hpp</span>
        <span id="tag"><!--?lit$8292145023$--></span>
      </div>
      ...
      <div role="gridcell">
        ...
        <a id="url" target="_blank" focus-row-control="" focus-type="url" hidden="" href="chrome://downloads/" tabindex="0"><!--?lit$8292145023$-->chrome://downloads</a>
      </div>

      <div class="description" role="gridcell" description-color="">
        <!--?lit$8292145023$-->0 B/s - 0 B
      </div>
...
<div id="hoverBackground" part="hoverBackground"></div></template>
    ...
    <div class="more-options">
      ...
      <div role="gridcell" id="action-icon-buttons">
        <cr-icon-button id="copy-download-link" iron-icon="downloads:link" title="复制下载链接" aria-label="复制下载链接" focus-row-control="" focus-type="copyDownloadLink" role="button" tabindex="0" aria-disabled="false"><template shadowrootmode="open"><!---->
<div id="icon">
  <div id="maskedImage"></div>
<cr-icon><template shadowrootmode="open"><svg id="baseSvg" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" focusable="false" style="pointer-events: none; display: block; width: 100%; height: 100%;" viewBox="0 0 24 24" class="cr-iconset-svg-icon_" role="none">
 <g>
        ...
        <cr-icon-button id="more-actions" iron-icon="cr:more-vert" class="dropdown-trigger" title="更多操作" aria-haspopup="menu" focus-row-control="" focus-type="actionMenuButton" role="button" tabindex="0" aria-disabled="false"><template shadowrootmode="open"><!---->
<div id="icon">
  <div id="maskedImage"></div>
<cr-icon><template shadowrootmode="open"><svg id="baseSvg" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" focusable="false" style="pointer-events: none; display: block; width: 100%; height: 100%;" viewBox="0 0 24 24" class="cr-iconset-svg-icon_" role="none">
 <g>
        ...
        <cr-icon-button id="quick-show-in-folder" class="icon-folder-open" focus-row-control="" focus-type="quickShow" title="在文件夹中显示" aria-label="在文件夹中显示" role="button" tabindex="0" aria-disabled="false" hidden=""><template shadowrootmode="open"><!---->
<div id="icon">
  <div id="maskedImage"></div>
</div><cr-ripple id="ink"><template shadowrootmode="open"><!----></template></cr-ripple></template>
        </cr-icon-button>
        <cr-icon-button id="quick-remove" class="icon-clear" title="从下载记录中删除" aria-label="从下载记录中删除" focus-row-control="" focus-type="quickRemove" role="button" tabindex="0" aria-disabled="false" hidden=""><template shadowrootmode="open"><!---->
<div id="icon">
  <div id="maskedImage"></div>
</div></template>
        </cr-icon-button>
      </div>
      <cr-action-menu id="more-actions-menu" role-description="操作"><template shadowrootmode="open"><!---->
<dialog id="dialog" part="dialog" role="application" aria-roledescription="操作">
  <div id="wrapper" class="item-wrapper" role="menu" tabindex="-1">
    <slot id="contentNode"></slot>
      ...
      <div id="incognito" title="已在隐身模式下进行下载" hidden="">
      </div>
    </div>
  </div>
...
<div id="date" role="heading" aria-level="2"><!--?lit$8292145023$--></div>

<div id="content" focus-row-container="" class="is-active">
  <div id="main-content">
    <div id="file-icon-wrapper" class="icon-wrapper" role="img" aria-label="" aria-hidden="true">
      <img class="icon" id="file-icon" alt="" icon-color="" src="chrome://fileicon/?path=C%3A%5CUsers%5CY9000P%5CDownloads%5Cjson.hpp&amp;scale=1.5x">
      <cr-icon class="icon" icon-color="" hidden=""><template shadowrootmode="open"><!----></template>
      </cr-icon>
    </div>
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        Can't have any line breaks.
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="https://release-assets.githubusercontent.com/github-production-release-asset/11171548/37e0337d-20df-4402-9e32-ed6e30ffb116?sp=r&amp;sv=2018-11-09&amp;sr=b&amp;spr=https&amp;se=2026-04-05T09%3A21%3A08Z&amp;rscd=attachment%3B+filename%3Djson.hpp&amp;rsct=application%2Foctet-stream&amp;skoid=96c2d410-5711-43a1-aedd-ab1947aa7ab0&amp;sktid=398a6654-997b-47e9-b12b-9515b896b4de&amp;skt=2026-04-05T08%3A21%3A08Z&amp;ske=2026-04-05T09%3A21%3A08Z&amp;sks=b&amp;skv=2018-11-09&amp;sig=ZwJo2CJDXNdBoQYhIvJazxSVALEXoMvcL8v2ilq7eM0%3D&amp;jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJnaXRodWIuY29tIiwiYXVkIjoicmVsZWFzZS1hc3NldHMuZ2l0aHVidXNlcmNvbnRlbnQuY29tIiwia2V5Ijoia2V5MSIsImV4cCI6MTc3NTM3ODM1NCwibmJmIjoxNzc1Mzc4MDU0LCJwYXRoIjoicmVsZWFzZWFzc2V0cHJvZHVjdGlvbi5ibG9iLmNvcmUud2luZG93cy5uZXQifQ.-30FzeJdeovqiex_LhO6tcbJp7I9d6qqyf6pCbDSYt4&amp;response-content-disposition=attachment%3B%20filename%3Djson.hpp&amp;response-content-type=application%2Foctet-stream" title="json.hpp" tabindex="-1" role="link"><!-- No line break
          --><!--?lit$8292145023$-->json.hpp<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="json.hpp" hidden=""><!-- No line break
          --><!--?lit$8292145023$-->json.hpp</span>
        <span id="tag"><!--?lit$8292145023$--></span>
      </div>
      ...
      <div role="gridcell">
        ...
        <a id="url" target="_blank" focus-row-control="" focus-type="url" hidden="" href="https://release-assets.githubusercontent.com/github-production-release-asset/11171548/37e0337d-20df-4402-9e32-ed6e30ffb116?sp=r&amp;sv=2018-11-09&amp;sr=b&amp;spr=https&amp;se=2026-04-05T09%3A21%3A08Z&amp;rscd=attachment%3B+filename%3Djson.hpp&amp;rsct=application%2Foctet-stream&amp;skoid=96c2d410-5711-43a1-aedd-ab1947aa7ab0&amp;sktid=398a6654-997b-47e9-b12b-9515b896b4de&amp;skt=2026-04-05T08%3A21%3A08Z&amp;ske=2026-04-05T09%3A21%3A08Z&amp;sks=b&amp;skv=2018-11-09&amp;sig=ZwJo2CJDXNdBoQYhIvJazxSVALEXoMvcL8v2ilq7eM0%3D&amp;jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJnaXRodWIuY29tIiwiYXVkIjoicmVsZWFzZS1hc3NldHMuZ2l0aHVidXNlcmNvbnRlbnQuY29tIiwia2V5Ijoia2V5MSIsImV4cCI6MTc3NTM3ODM1NCwibmJmIjoxNzc1Mzc4MDU0LCJwYXRoIjoicmVsZWFzZWFzc2V0cHJvZHVjdGlvbi5ibG9iLmNvcmUud2luZG93cy5uZXQifQ.-30FzeJdeovqiex_LhO6tcbJp7I9d6qqyf6pCbDSYt4&amp;response-content-disposition=attachment%3B%20filename%3Djson.hpp&amp;response-content-type=application%2Foctet-stream" tabindex="-1"><!--?lit$8292145023$-->https://release-assets.githubusercontent.com</a>
      </div>
...
<div id="hoverBackground" part="hoverBackground"></div></template>
    ...
    <div class="more-options">
      <!-- Menu and/or quick action(s). -->
      <div role="gridcell" id="action-icon-buttons">
        <cr-icon-button id="copy-download-link" iron-icon="downloads:link" title="复制下载链接" aria-label="复制下载链接" focus-row-control="" focus-type="copyDownloadLink" role="button" tabindex="-1" aria-disabled="false"><template shadowrootmode="open"><!---->
<div id="icon">
  <div id="maskedImage"></div>
<cr-icon><template shadowrootmode="open"><svg id="baseSvg" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" focusable="false" style="pointer-events: none; display: block; width: 100%; height: 100%;" viewBox="0 0 24 24" class="cr-iconset-svg-icon_" role="none">
 <g>
        ...
        <cr-icon-button id="more-actions" iron-icon="cr:more-vert" class="dropdown-trigger" title="更多操作" aria-haspopup="menu" focus-row-control="" focus-type="actionMenuButton" hidden="" role="button" tabindex="-1" aria-disabled="false"><template shadowrootmode="open"><!---->
<div id="icon">
  <div id="maskedImage"></div>
<cr-icon><template shadowrootmode="open"><svg id="baseSvg" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" focusable="false" style="pointer-events: none; display: block; width: 100%; height: 100%;" viewBox="0 0 24 24" class="cr-iconset-svg-icon_" role="none">
 <g>
        ...
        <cr-icon-button id="quick-show-in-folder" class="icon-folder-open" focus-row-control="" focus-type="quickShow" title="在文件夹中显示" aria-label="在文件夹中显示" role="button" tabindex="-1" aria-disabled="false"><template shadowrootmode="open"><!---->
<div id="icon">
  <div id="maskedImage"></div>
</div></template>
        </cr-icon-button>
        <cr-icon-button id="quick-remove" class="icon-clear" title="从下载记录中删除" aria-label="从下载记录中删除" focus-row-control="" focus-type="quickRemove" role="button" tabindex="-1" aria-disabled="false"><template shadowrootmode="open"><!---->
<div id="icon">
  <div id="maskedImage"></div>
</div></template>
        </cr-icon-button>
...
<div id="content" focus-row-container="" class="is-active">
  <div id="main-content">
    <div id="file-icon-wrapper" class="icon-wrapper" role="img" aria-label="" aria-hidden="true">
      <img class="icon" id="file-icon" alt="" icon-color="" src="chrome://fileicon/?path=C%3A%5CUsers%5CY9000P%5CDownloads%5C%E4%B8%AD%E5%9C%BA%E7%AC%AC4%E8%AF%BE+%E5%B7%A5%E7%A8%8B%E9%87%8D%E6%9E%84%E4%B8%8E%E9%85%8D%E7%BD%AE%282%29+%281%29.pptx&amp;scale=1.5x">
      <cr-icon class="icon" icon-color="" hidden=""><template shadowrootmode="open"><!----></template>
      </cr-icon>
    </div>
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        Can't have any line breaks.
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="file:///D:/Program%20Files/xwechat_files/wxid_392agbc0qo2832_2396/msg/file/2026-03/%E4%B8%AD%E5%9C%BA%E7%AC%AC4%E8%AF%BE%20%E5%B7%A5%E7%A8%8B%E9%87%8D%E6%9E%84%E4%B8%8E%E9%85%8D%E7%BD%AE(2).pptx" title="中场第4课 工程重构与配置(2) (1).pptx" tabindex="-1" role="link"><!-- No line break
          --><!--?lit$8292145023$-->中场第4课 工程重构与配置(2) (1).pptx<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="中场第4课 工程重构与配置(2) (1).pptx" hidden=""><!-- No line break
          --><!--?lit$8292145023$-->中场第4课 工程重构与配置(2) (1).pptx</span>
        <span id="tag"><!--?lit$8292145023$--></span>
      </div>
      ...
      <div role="gridcell">
        ...
        <a id="url" target="_blank" focus-row-control="" focus-type="url" hidden="" href="file:///D:/Program%20Files/xwechat_files/wxid_392agbc0qo2832_2396/msg/file/2026-03/%E4%B8%AD%E5%9C%BA%E7%AC%AC4%E8%AF%BE%20%E5%B7%A5%E7%A8%8B%E9%87%8D%E6%9E%84%E4%B8%8E%E9%85%8D%E7%BD%AE(2).pptx" tabindex="-1"><!--?lit$8292145023$-->file:///D:/Program%20Files/xwechat_files/wxid_392agbc0qo2832_2396/msg/file/2026-03/%E4%B8%AD%E5%9C%BA%E7%AC%AC4%E8%AF%BE%20%E5%B7%A5%E7%A8%8B%E9%87%8D%E6%9E%84%E4%B8%8E%E9%85%8D%E7%BD%AE(2).pptx</a>
      </div>
...
<div id="content" focus-row-container="" class="is-active">
  <div id="main-content">
    <div id="file-icon-wrapper" class="icon-wrapper" role="img" aria-label="" aria-hidden="true">
      <img class="icon" id="file-icon" alt="" icon-color="" src="chrome://fileicon/?path=C%3A%5CUsers%5CY9000P%5CDownloads%5C%E4%B8%AD%E5%9C%BA%E7%AC%AC3%E8%AF%BE+%E8%AE%A9%E7%90%83%E6%B4%BB%E5%8A%A8%281%29+%286%29.pptx&amp;scale=1.5x">
      <cr-icon class="icon" icon-color="" hidden=""><template shadowrootmode="open"><!----></template>
      </cr-icon>
    </div>
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        Can't have any line breaks.
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="file:///D:/Program%20Files/xwechat_files/wxid_392agbc0qo2832_2396/msg/file/2026-03/%E4%B8%AD%E5%9C%BA%E7%AC%AC3%E8%AF%BE%20%E8%AE%A9%E7%90%83%E6%B4%BB%E5%8A%A8(1).pptx" title="中场第3课 让球活动(1) (6).pptx" tabindex="-1" role="link"><!-- No line break
          --><!--?lit$8292145023$-->中场第3课 让球活动(1) (6).pptx<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="中场第3课 让球活动(1) (6).pptx" hidden=""><!-- No line break
          --><!--?lit$8292145023$-->中场第3课 让球活动(1) (6).pptx</span>
        <span id="tag"><!--?lit$8292145023$--></span>
      </div>
      ...
      <div role="gridcell">
        ...
        <a id="url" target="_blank" focus-row-control="" focus-type="url" hidden="" href="file:///D:/Program%20Files/xwechat_files/wxid_392agbc0qo2832_2396/msg/file/2026-03/%E4%B8%AD%E5%9C%BA%E7%AC%AC3%E8%AF%BE%20%E8%AE%A9%E7%90%83%E6%B4%BB%E5%8A%A8(1).pptx" tabindex="-1"><!--?lit$8292145023$-->file:///D:/Program%20Files/xwechat_files/wxid_392agbc0qo2832_2396/msg/file/2026-03/%E4%B8%AD%E5%9C%BA%E7%AC%AC3%E8%AF%BE%20%E8%AE%A9%E7%90%83%E6%B4%BB%E5%8A%A8(1).pptx</a>
      </div>
...
<div id="date" role="heading" aria-level="2"><!--?lit$8292145023$-->昨天</div>

<div id="content" focus-row-container="" class="is-active">
  <div id="main-content">
    <div id="file-icon-wrapper" class="icon-wrapper" role="img" aria-label="" aria-hidden="true">
      <img class="icon" id="file-icon" alt="" icon-color="" src="chrome://fileicon/?path=C%3A%5CUsers%5CY9000P%5CDownloads%5C%E4%B8%AD%E5%9C%BA%E7%AC%AC3%E8%AF%BE+%E8%AE%A9%E7%90%83%E6%B4%BB%E5%8A%A8%281%29+%285%29.pptx&amp;scale=1.5x">
      <cr-icon class="icon" icon-color="" hidden=""><template shadowrootmode="open"><!----></template>
      </cr-icon>
    </div>
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        Can't have any line breaks.
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="file:///D:/Program%20Files/xwechat_files/wxid_392agbc0qo2832_2396/msg/file/2026-03/%E4%B8%AD%E5%9C%BA%E7%AC%AC3%E8%AF%BE%20%E8%AE%A9%E7%90%83%E6%B4%BB%E5%8A%A8(1).pptx" title="中场第3课 让球活动(1) (5).pptx" tabindex="-1" role="link"><!-- No line break
          --><!--?lit$8292145023$-->中场第3课 让球活动(1) (5).pptx<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="中场第3课 让球活动(1) (5).pptx" hidden=""><!-- No line break
          --><!--?lit$8292145023$-->中场第3课 让球活动(1) (5).pptx</span>
        <span id="tag"><!--?lit$8292145023$--></span>
      </div>
...
<!--_html_template_end_--></template>
  ...
  <div id="no-downloads" hidden="">
    <div>
      ...
      <span><!--?lit$8292145023$-->您下载的文件会显示在此处</span>
    </div>
  </div>
</div>
...
<cr-toast id="toast"><template shadowrootmode="open"><!----><slot></slot></template>
  ...
  <cr-button aria-label="按 Ctrl+Z 即可撤消" role="button" tabindex="0" aria-disabled="false"><template shadowrootmode="open"><!---->
<div id="background"></div>
<slot id="prefixIcon" name="prefix-icon">
</slot>
<span id="content"><slot></slot></span>
